...
export default function BoxIconComments({
  ...
  return (
    <BoxCommentsStyle data-test="comment-btn" onClick={() => setShowComments(!showComments)}>
      <StyledCommentsIcon />
      <CommentsCount data-test="comment-counter">{commentsCount} comments</CommentsCount>
    </BoxCommentsStyle>
  );
}
